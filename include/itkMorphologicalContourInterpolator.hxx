...
public:
  ...
  typedef itk::DomainThreader< itk::ThreadedIndexedContainerPartitioner, MorphologicalContourInterpolator< TImage > > Superclass;
  ...
  ThreadedExecution( const DomainType& subDomain, const ThreadIdType threadId )
  {
    ...
    for ( itk::IndexValueType ii = subDomain[0]; ii <= subDomain[1] && ii < IndexValueType( m_WorkArray.size() ); ++ii )
      ...
      this->m_Associate->InterpolateBetweenTwo(
        m_WorkArray[ii].axis, m_WorkArray[ii].out, m_WorkArray[ii].label, m_WorkArray[ii].i, m_WorkArray[ii].j, m_WorkArray[ii].iconn, m_WorkArray[ii].jconn, threadId );
      }
  } // ThreadedExecution
...
void
MorphologicalContourInterpolator< TImage >
::Extrapolate( int axis, TImage* out, typename TImage::PixelType label, typename TImage::IndexValueType i, typename TImage::IndexValueType j,
  typename SliceType::Pointer& iConn, typename TImage::PixelType iRegionId, ThreadIdType threadId )
{
...
void
MorphologicalContourInterpolator< TImage >
::Interpolate1to1( int axis, TImage* out, typename TImage::PixelType label, typename TImage::IndexValueType i, typename TImage::IndexValueType j,
  typename SliceType::Pointer& iConn, typename TImage::PixelType iRegionId, typename SliceType::Pointer& jConn,
  typename TImage::PixelType jRegionId, const typename SliceType::IndexType& translation, bool recursive, ThreadIdType threadId )
{
...
void
MorphologicalContourInterpolator< TImage >
::Interpolate1toN( int axis, TImage* out, typename TImage::PixelType label, typename TImage::IndexValueType i, typename TImage::IndexValueType j,
  ...
  const typename SliceType::IndexType& translation, ThreadIdType threadId )
{
...
void
MorphologicalContourInterpolator< TImage >
::InterpolateBetweenTwo( int axis, TImage* out, typename TImage::PixelType label, typename TImage::IndexValueType i, typename TImage::IndexValueType j,
  typename SliceType::Pointer& iconn, typename SliceType::Pointer& jconn, ThreadIdType threadId )
{
